...
<body>
  ...
  <div class="container bd">
    <div class="row ">
      ...
      <div class="col-md-6">
        <form action="search_star.php" method="GET">
          <input type="text" class="form-control mr-sm-2" placeholder="Actor Name" name="act">
          <br>
          <input type="submit" value="Search" name="sub_act" class="form-control btn btn-outline-info">
        </form>
      </div>
