...
<body>
  ...
  <div class="container bd">
    <div class="row ">
      ...
      <div class="col-md-6">
        <form action="search_dir.php" method="GET">
          <input type="text" class="form-control mr-sm-2" placeholder="Director Name" name="dir">
          <br>
          <input type="submit" value="Search" name="sub_dir" class="form-control btn btn-outline-info">
        </form>
      </div>
