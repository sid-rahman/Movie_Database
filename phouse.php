...
<body>
  ...
  <div class="container bd">
    <div class="row ">
      ...
      <div class="col-md-6">
        <form action="search_phouse.php" method="GET">
          <input type="text" class="form-control mr-sm-2" placeholder="Production House" name="ph">
          <br>
          <input type="submit" value="SEARCH" name="sub_ph" class="form-control btn btn-outline-info">
        </form>
      </div>
