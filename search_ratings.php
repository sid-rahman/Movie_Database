    ...
    <div class="col-6">
        <?php
            if(isset($_GET['sub_rat'])){
                ...
                echo "<h2 >List of movies whose rating above <strong> $name </strong></h2> <hr> <br>";
                if($con){
                    $q="select m_name from movie where m_id IN (select m_id FROM movie Where ratings > '$name');";
