...
<body>
  ...
  <div class="container bd">
    <div class="row ">
      ...
      <div class="col-md-6">
        <form action="search_ratings.php" method="GET">
          <input type="text" class="form-control mr-sm-2" placeholder="Rating" name="rat">
          <br>
          <input type="submit" value="Search" name="sub_rat" class="form-control btn btn-outline-info">
        </form>
      </div>
      <div class="col-md-3">
