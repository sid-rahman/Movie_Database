...
<body>
  ...
  <div class="container center2">
    ...
    <h2>Insert a movie: </h2> <br>
    <form action="after.php" class="form-control" method="GET">
        Movie Name: <input type="text" class="form-control" name="m"> <br>
        Run time: <input type="text" class="form-control" name="rt"> <br>
        Genre: <input type="text" class="form-control" name="gn"> <br>
        Rating: <input type="text" class="form-control" name="rat"> <br>
        Released Year: <input type="text" class="form-control" name="ry"> <br>
