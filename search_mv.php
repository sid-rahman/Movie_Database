    ...
    <div class="col-6">
        <?php
            if(isset($_GET['sub'])){
                ...
                echo "<h2 >Movie: <strong> $name </strong></h2> <hr> <br>";
                if($con){
                    $q="select * from movie  where m_name='$name';";
                    $res=mysqli_query($con,$q);
                    while($row=mysqli_fetch_row($res)){
                        $m=$row[2];
                        echo "<h5 class='border border-buttom'>Run time: $m min</h5> <br>";

                        echo '<br>';
                        $m=$row[3];
                        echo "<h5 class='border border-buttom'>Genre: $m</h5><br>";

                        echo '<br>';
                        $m=$row[4];
                        echo "<h5 class='border border-buttom'>Rating: $m</h5> <br>";

                        echo '<br>';
                        $m=$row[5];
                        echo "<h5 class='border border-buttom'>Released Year: $m</h5> ";
