    ...
    <div class="col-6">
        <?php
            if(isset($_GET['sub_adv'])){
                ...
                echo "<h3 >Genre: <strong> $first </strong> <br> Released Year: <strong>  $second </strong> <br> Ratings: <strong>  $third </strong> </h3> <hr> <br>";
                if($con){
                  $q="SELECT m_name FROM movie WHERE  (genre = '$first' AND r_year = '$second' AND ratings>= '$third') OR (genre = '$first' AND r_year = '$second' AND ratings<0);";
